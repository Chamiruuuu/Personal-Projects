...
function displayWeather(currentData){
    ...
    if(temp > 25){
        ...
        maincontainer.style.backgroundImage = `url(${'clearsky.jpg'})`

    } else if(temp >= 20 && temp <= 25){
        Weatheremoji.textContent = "🌤️"
        weatherdesc.textContent = "Partly Cloudy"
        maincontainer.style.backgroundImage = `url(${'partlycloudy.jpg'})`
        ...
        maincontainer.style.backgroundImage =`url(${'Snowy.jpg'})`
    }
}